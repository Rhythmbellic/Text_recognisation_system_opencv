...
#find contours
contour,heirarch=cv2.findContours(thresh,cv2.RETR_TREE,cv2.CHAIN_APPROX_NONE)
cv2.imshow('threshold',thresh)

#check if there is contour or not
...
#find percpective transform matrix and unwarp

src=np.float32([approx[1,0],approx[0,0],approx[3,0],approx[2,0]])
...
#pre proccess image for text extraction
